...
- [`/.well-known/action-catalog.json`](https://mcp.agentweb.us/.well-known/action-catalog.json) — allowed and disallowed action families
- [`/.well-known/sandbox.json`](https://mcp.agentweb.us/.well-known/sandbox.json) — sandbox limits
